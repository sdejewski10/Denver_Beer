...
beer_abv_list.insert(3,'7.2% ABV')
beer_abv_list.pop(4)
beer_abv_list.insert(7, '4.7% ABV')
beer_abv_list.pop(8)
beer_abv_list.insert(11,'14.9% ABV')
beer_abv_list.pop(12)
#print(beer_abv_list)
...
Black_Shirt_df.to_csv('Black_Shirt_Data.csv',index=False,header=True)
